...
RUN mkdir -p /usr/local/lib/fennel-mcp
COPY lib/parinfer.fnl /usr/local/lib/fennel-mcp/parinfer.fnl
COPY fennel-repl-server.fnl /usr/local/lib/fennel-mcp/fennel-repl-server.fnl
